...
CREATE TABLE "Deployment" (
    ...
    "contractAddress" TEXT,
    "gasEstimateWei" TEXT,
    "status" "DeploymentStatus" NOT NULL DEFAULT 'PREPARED',
    "errorMessage" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Mint" (
    ...
    "totalPaidWei" TEXT NOT NULL,
    "creatorAmountWei" TEXT NOT NULL,
    "nestFeeAmountWei" TEXT NOT NULL,
...
CREATE TABLE "Referral" (
    ...
    "collectionId" TEXT,
    "revenueGenerated" TEXT NOT NULL DEFAULT '0',
    "commissionStatus" TEXT NOT NULL DEFAULT 'PLACEHOLDER',
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
